...
fapp.midi.prepare = function() {
  ...
  if (navigator.requestMIDIAccess) {
    ...
    }).then(fapp.onMIDISuccess, fapp.onMIDIFailure);
  } else {
...
// midi functions
fapp.onMIDISuccess = function(midiAccess) {
